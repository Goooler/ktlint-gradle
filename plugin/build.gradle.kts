...
dependencies {
    ...
    add("adapter49CompileOnly", "com.pinterest.ktlint:ktlint-ruleset-standard:1.1.1")
    ...
    add("adapter50CompileOnly", "com.pinterest.ktlint:ktlint-ruleset-standard:1.1.1")
    ...
    add("adapter100CompileOnly", "com.pinterest.ktlint:ktlint-ruleset-standard:1.1.1")
